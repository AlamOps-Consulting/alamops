...
export const dict = {
  en: {
    ...
    status: {
      brand: "AlamOps · System status",
      headline: {
        operational: "All systems operational",
        degraded: "Degraded performance on some systems",
        partial_outage: "Partial outage on some systems",
        major_outage: "Major outage in progress",
      },
      updated: "Updated",
      failedTitle: "System status",
      failedBody: "Unable to load status right now. Please try again in a few minutes.",
      activeIncidents: "Ongoing incidents",
      services: "Services",
      uptimeWindow: "Uptime over the last {days} days",
      pastIncidents: "Recent history",
      noPast: "No recent resolved incidents.",
      ...
      admin: {
        title_a: "Status",
        title_b: "page.",
        subtitle: "Manage status and incidents",
        refresh: "Refresh",
        loading: "Loading…",
        noData: "No data.",
        groupsHeader: "Service groups",
        createIncidentHeader: "Create incident",
        formTitle: "Incident title",
        formSeverity: "Severity",
        formInitialStatus: "Initial status",
        formAffected: "Affected groups",
        formMessage: "Initial message",
        formSubmit: "Create incident",
        formSubmitting: "Creating…",
        validationError: "Title, group and message are required",
        createdToast: "Incident created",
        statusUpdatedToast: "Status updated: {label}",
        activeHeader: "Active incidents ({n})",
        pastHeader: "Recently resolved ({n})",
        noActive: "No active incidents.",
        noPast: "No resolved incidents.",
        groupsLabel: "Groups",
        resolve: "Resolve",
        delete: "Delete",
        confirmDelete: "Delete \"{title}\"?",
        addUpdate: "Add",
        updatePlaceholder: "Update message",
        messageRequired: "Message required",
        updateAddedToast: "Update added",
        resolvedToast: "Resolved",
        resolvedDefault: "Incident resolved",
        deletedToast: "Incident deleted",
        genericError: "Error",
      },
    },
  },
  es: {
    ...
    status: {
      brand: "AlamOps · Estado del sistema",
      headline: {
        operational: "Todos los sistemas operativos",
        degraded: "Rendimiento degradado en algunos sistemas",
        partial_outage: "Interrupción parcial en algunos sistemas",
        major_outage: "Interrupción mayor en curso",
      },
      updated: "Actualizado",
      failedTitle: "Estado del sistema",
      failedBody: "No se pudo obtener el estado en este momento. Intenta de nuevo en unos minutos.",
      activeIncidents: "Incidentes en curso",
      services: "Servicios",
      uptimeWindow: "Uptime últimos {days} días",
      pastIncidents: "Historial reciente",
      noPast: "No hay incidentes recientes resueltos.",
      ...
      admin: {
        title_a: "Status",
        title_b: "page.",
        subtitle: "Gestión de estado e incidentes",
        refresh: "Refrescar",
        loading: "Cargando…",
        noData: "Sin datos.",
        groupsHeader: "Grupos de servicios",
        createIncidentHeader: "Crear incidente",
        formTitle: "Título del incidente",
        formSeverity: "Severidad",
        formInitialStatus: "Estado inicial",
        formAffected: "Grupos afectados",
        formMessage: "Mensaje inicial",
        formSubmit: "Crear incidente",
        formSubmitting: "Creando…",
        validationError: "Título, grupo y mensaje son obligatorios",
        createdToast: "Incidente creado",
        statusUpdatedToast: "Estado actualizado: {label}",
        activeHeader: "Incidentes activos ({n})",
        pastHeader: "Resueltos recientes ({n})",
        noActive: "Sin incidentes activos.",
        noPast: "Sin incidentes resueltos.",
        groupsLabel: "Grupos",
        resolve: "Resolver",
        delete: "Eliminar",
        confirmDelete: "Eliminar \"{title}\"?",
        addUpdate: "Añadir",
        updatePlaceholder: "Mensaje de actualización",
        messageRequired: "Mensaje requerido",
        updateAddedToast: "Actualización añadida",
        resolvedToast: "Resuelto",
        resolvedDefault: "Incidente resuelto",
        deletedToast: "Incidente eliminado",
        genericError: "Error",
      },
    },
  },
