          ...
          <div key={index} className={`carousel-slide ${slide}`} style={{ flex: "0 0 100%" }}>
            {slide === "cloud-providers" && (
              <div className="provider-grid">
                <div className="provider-card">
                    <svg className="cloud-logo aws" viewBox="0 0 100 100">
                ...
                <div className="provider-card">
                    <svg className="cloud-logo azure" viewBox="0 0 100 100">
                ...
                <div className="provider-card">
                    <svg className="cloud-logo gcp" viewBox="0 0 100 100">
            ...
            {slide === "devops-tools" && (
                <div className="tools-grid">
                    <div className="tool-item">
                        <svg className="tool-logo kubernetes" viewBox="0 0 100 100">
                    ...
                    <div className="tool-item">
                        <svg className="tool-logo terraform" viewBox="0 0 100 100">
                    ...
                    <div className="tool-item">
                        <svg className="tool-logo docker" viewBox="0 0 100 100">
            ...
            {slide === "monitoring-stack" && (
                <div className="monitoring-tools">
                    ...
                    <svg className="tool-logo prometheus" viewBox="0 0 100 100">
                        <path d="M50,20c-16.6,0-30,13.4-30,30s13.4,30,30,30s30-13.4,30-30S66.6,20,50,20z M50,70c-11,0-20-9-20-20s9-20,20-20
                        s20,9,20,20S61,70,50,70z"/>
                    </svg>
                    ...
                    <div className="tool-row">
                    <svg className="tool-logo grafana" viewBox="0 0 100 100">
                        <path d="M50,20c-16.6,0-30,13.4-30,30s13.4,30,30,30s30-13.4,30-30S66.6,20,50,20z M65,65H35V35h30V65z"/>
                    </svg>
                    <span>Grafana</span>
                    </div>
                    <div className="tool-row">
                    <svg className="tool-logo loki" viewBox="0 0 100 100">
